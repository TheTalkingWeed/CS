...
namespace String1
{
    class Sztringek1
    {
        ...
        {
            return s.Length < 2 ? "" : s.Substring(0,2) + s.Substring(s.Length-2,2);
        }
        ...
        {
            return s[0]+s.Substring(1,s.Length-1).Replace(s[0],'*');
        }
        ...
        {
            return b.Substring(0,2) + a.Substring(2,a.Length-2) + " " + a.Substring(0,2) + b.Substring(2,b.Length-2);
        }
